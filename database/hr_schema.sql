...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2023 at 11:12 AM
...
(209, 'Syafiq', 'Zolkeply', 's.zolkeply@shu.ac.uk', '0788499987', '2023-02-07', 6, '5000.00', 108, 10);
...
--
ALTER TABLE `employees`
  MODIFY `employee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210;
--
